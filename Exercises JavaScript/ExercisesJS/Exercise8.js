...
const Me = {
        ...
        document.write(`
            <div class="networks">
                ...
                for(const key in this.SocialNetworks) {
                    document.write(`
                    <a href="${this.SocialNetworks[key][0]}" target="_blank">
                        <li>${this.SocialNetworks[key][1]}</li>
                    </a>`
                    );
                }
    ...
    Portafolio : function(){
        ...
        for (const key in this.Portfolio) {
            ...
            <div class = "web">
                <p>
                    Nombre : ${this.Portfolio[key].NameSite}<br><br>
                    Descripcion : ${this.Portfolio[key].Description}<br><br>
                    <a class="button" href="${this.Portfolio[key].Link}" target="_blank">Link</a> <br><br>
                </p>
            </div>
            `);
        }
