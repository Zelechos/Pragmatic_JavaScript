// Aplicacion en JS que muestra una lista de enlaces para redireccionar la web con puro JS
const Lenguajes = [" Java "," Python "," JavaScript "," Go "," Php "," Scala "," C " ," C++ "," C# "," SQL "," R "," Julia ", " TypeScript", "Rust"];
...
Lenguajes.forEach((values, index)=>{
